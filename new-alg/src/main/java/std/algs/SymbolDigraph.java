 ...
 *  {@link std.algs.Digraph} data type, which assumes the vertex names are integers
 *  between 0 and <em>V</em> - 1.
 *  It also supports initializing a symbol digraph from a file.
 *  <p>
 *  This implementation uses an {@link std.algs.ST} to map from strings to integers,
 *  an array to map from integers to strings, and a {@link std.algs.Digraph} to store
